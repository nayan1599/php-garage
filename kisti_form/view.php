...
// মোট পরিশোধের পরিমাণ
$total_paid += $sale['down_payment']; // ডাউন পেমেন্ট যোগ করা হয়েছে
...
<body class="container mt-4">
  ...
  <table class="table table-bordered">
    <tbody>
        ...
        <tr>
            <th>বিলম্ব ফি (৳)</th>
            <td><?= number_format($sale['late_fee'], 2) ?></td>
        </tr>
        <tr>
            <th>মোট মূল্য (৳)</th>
        ...
        <tr>
            <th>মোট বিলম্ব ফি (৳)</th>
            <td><?= number_format($sale['late_fee'] * ($sale['total_installments'] - $sale['remaining_installments']), 2) ?></td>
        </tr>   
        <tr>
            <th>মোট পরিশোধ (৳)</th>
    ...
    <a href="index.php?page=kisti_form/index" class="btn btn-secondary mt-3">🔙 তালিকায় ফিরে যান</a>
</body>
</html>
